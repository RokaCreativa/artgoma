  ...
  return (
    ...
    >
      <div className="relative flex h-screen overflow-hidden overflow-y-auto">
        <Link
          className="flex items-center fixed z-[200] left-4 top-4 lg:left-8 lg:top-8 text-xl text-primary bg-secondary border-2 border-primary pl-2 pr-4 py-1 rounded-xl hover:bg-[#bcb9978a] transition-colors group"
          href={`/${lang}`}
        >
        ...
        <div className="flex w-screen justify-center items-start pt-32">
