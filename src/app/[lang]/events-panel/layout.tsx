...
const layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="relative overflow-hidden overflow-y-scroll bg-black h-screen">
      <Circle
      ...
      <div className="relative flex flex-col items-center justify-start w-full p-2 my-20">{children}</div>
    </div>
  );
};
