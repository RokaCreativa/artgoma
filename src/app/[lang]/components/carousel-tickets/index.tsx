...
const GoldenTicketsCarousel = () => {
  const carouselBrands = useCarouselGoldenTickets();

  return (
    <section className="bg-[#1c1f24] w-full inline-flex flex-nowrap overflow-x-hidden pb-8 lg:h-80">
