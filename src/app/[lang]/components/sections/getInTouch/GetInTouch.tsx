...
import { Mail, MapPinIcon, PhoneCall, User2Icon, UserCircle2 } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row items-end justify-between pl-16 pr-10 lg:pr-32 pt-6 md:pt-16">
        ...
        <div className="flex flex-col w-11/12 md:w-3/5 lg:w-1/3">
          ...
          <a
            ...
            className="flex justify-between gap-2 mb-2 px-4"
          >
          ...
          <a
            ...
            className="flex justify-between gap-2 px-4"
          >
            <Mail stroke="#ffffff" />
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href={"https://maps.app.goo.gl/gj1YJZ8sSVYZ6zQg6"}
            className="flex justify-between gap-2 px-4 py-1"
          >
            <MapPinIcon stroke="#ffffff" />
            <p className="text-white font-semibold text-end">Av. Ayyo Nr. 73, Local 7, 38670 Adeje</p>
          </a>
        </div>
      </div>
    </div>
