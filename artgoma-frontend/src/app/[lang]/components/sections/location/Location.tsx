    ...
    <div id="contact" className="bg-[#1c1f24] pt-16 md:pt-32">
      ...
      <div className="flex gap-8 flex-col md:flex-row justify-between items-center px-4 py-8">
        <div className="flex justify-center w-full">
          <div>
            <a target="_blank" rel="noopener noreferrer" href={"https://maps.app.goo.gl/gj1YJZ8sSVYZ6zQg6"}>
              <MapPin className="stroke-white h-20 w-20 md:h-48 md:w-48 md:-translate-y-32 md:translate-x-2 hover:scale-105 duration-300" />
            </a>
